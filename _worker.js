var Ge=Object.defineProperty;var re=t=>{throw TypeError(t)};var Ue=(t,e,r)=>e in t?Ge(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var g=(t,e,r)=>Ue(t,typeof e!="symbol"?e+"":e,r),qt=(t,e,r)=>e.has(t)||re("Cannot "+r);var p=(t,e,r)=>(qt(t,e,"read from private field"),r?r.call(t):e.get(t)),m=(t,e,r)=>e.has(t)?re("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,r),h=(t,e,r,n)=>(qt(t,e,"write to private field"),n?n.call(t,r):e.set(t,r),r),v=(t,e,r)=>(qt(t,e,"access private method"),r);var ne=(t,e,r,n)=>({set _(i){h(t,e,i,r)},get _(){return p(t,e,n)}});var ie=(t,e,r)=>(n,i)=>{let o=-1;return a(0);async function a(l){if(l<=o)throw new Error("next() called multiple times");o=l;let s,c=!1,d;if(t[l]?(d=t[l][0][0],n.req.routeIndex=l):d=l===t.length&&i||void 0,d)try{s=await d(n,()=>a(l+1))}catch(u){if(u instanceof Error&&e)n.error=u,s=await e(u,n),c=!0;else throw u}else n.finalized===!1&&r&&(s=await r(n));return s&&(n.finalized===!1||c)&&(n.res=s),n}},qe=Symbol(),We=async(t,e=Object.create(null))=>{const{all:r=!1,dot:n=!1}=e,o=(t instanceof _e?t.raw.headers:t.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Ye(t,{all:r,dot:n}):{}};async function Ye(t,e){const r=await t.formData();return r?Je(r,e):{}}function Je(t,e){const r=Object.create(null);return t.forEach((n,i)=>{e.all||i.endsWith("[]")?Ve(r,i,n):r[i]=n}),e.dot&&Object.entries(r).forEach(([n,i])=>{n.includes(".")&&(Xe(r,n,i),delete r[n])}),r}var Ve=(t,e,r)=>{t[e]!==void 0?Array.isArray(t[e])?t[e].push(r):t[e]=[t[e],r]:e.endsWith("[]")?t[e]=[r]:t[e]=r},Xe=(t,e,r)=>{if(/(?:^|\.)__proto__\./.test(e))return;let n=t;const i=e.split(".");i.forEach((o,a)=>{a===i.length-1?n[o]=r:((!n[o]||typeof n[o]!="object"||Array.isArray(n[o])||n[o]instanceof File)&&(n[o]=Object.create(null)),n=n[o])})},$e=t=>{const e=t.split("/");return e[0]===""&&e.shift(),e},Ke=t=>{const{groups:e,path:r}=Ze(t),n=$e(r);return Qe(n,e)},Ze=t=>{const e=[];return t=t.replace(/\{[^}]+\}/g,(r,n)=>{const i=`@${n}`;return e.push([i,r]),i}),{groups:e,path:t}},Qe=(t,e)=>{for(let r=e.length-1;r>=0;r--){const[n]=e[r];for(let i=t.length-1;i>=0;i--)if(t[i].includes(n)){t[i]=t[i].replace(n,e[r][1]);break}}return t},Rt={},tr=(t,e)=>{if(t==="*")return"*";const r=t.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const n=`${t}#${e}`;return Rt[n]||(r[2]?Rt[n]=e&&e[0]!==":"&&e[0]!=="*"?[n,r[1],new RegExp(`^${r[2]}(?=/${e})`)]:[t,r[1],new RegExp(`^${r[2]}$`)]:Rt[n]=[t,r[1],!0]),Rt[n]}return null},Ht=(t,e)=>{try{return e(t)}catch{return t.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return e(r)}catch{return r}})}},er=t=>Ht(t,decodeURI),Fe=t=>{const e=t.url,r=e.indexOf("/",e.indexOf(":")+4);let n=r;for(;n<e.length;n++){const i=e.charCodeAt(n);if(i===37){const o=e.indexOf("?",n),a=e.indexOf("#",n),l=o===-1?a===-1?void 0:a:a===-1?o:Math.min(o,a),s=e.slice(r,l);return er(s.includes("%25")?s.replace(/%25/g,"%2525"):s)}else if(i===63||i===35)break}return e.slice(r,n)},rr=t=>{const e=Fe(t);return e.length>1&&e.at(-1)==="/"?e.slice(0,-1):e},lt=(t,e,...r)=>(r.length&&(e=lt(e,...r)),`${(t==null?void 0:t[0])==="/"?"":"/"}${t}${e==="/"?"":`${(t==null?void 0:t.at(-1))==="/"?"":"/"}${(e==null?void 0:e[0])==="/"?e.slice(1):e}`}`),Ee=t=>{if(t.charCodeAt(t.length-1)!==63||!t.includes(":"))return null;const e=t.split("/"),r=[];let n="";return e.forEach(i=>{if(i!==""&&!/\:/.test(i))n+="/"+i;else if(/\:/.test(i))if(/\?/.test(i)){r.length===0&&n===""?r.push("/"):r.push(n);const o=i.replace("?","");n+="/"+o,r.push(n)}else n+="/"+i}),r.filter((i,o,a)=>a.indexOf(i)===o)},Wt=t=>/[%+]/.test(t)?(t.indexOf("+")!==-1&&(t=t.replace(/\+/g," ")),t.indexOf("%")!==-1?Ht(t,Xt):t):t,ke=(t,e,r)=>{let n;if(!r&&e&&!/[%+]/.test(e)){let a=t.indexOf("?",8);if(a===-1)return;for(t.startsWith(e,a+1)||(a=t.indexOf(`&${e}`,a+1));a!==-1;){const l=t.charCodeAt(a+e.length+1);if(l===61){const s=a+e.length+2,c=t.indexOf("&",s);return Wt(t.slice(s,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";a=t.indexOf(`&${e}`,a+1)}if(n=/[%+]/.test(t),!n)return}const i={};n??(n=/[%+]/.test(t));let o=t.indexOf("?",8);for(;o!==-1;){const a=t.indexOf("&",o+1);let l=t.indexOf("=",o);l>a&&a!==-1&&(l=-1);let s=t.slice(o+1,l===-1?a===-1?void 0:a:l);if(n&&(s=Wt(s)),o=a,s==="")continue;let c;l===-1?c="":(c=t.slice(l+1,a===-1?void 0:a),n&&(c=Wt(c))),r?(i[s]&&Array.isArray(i[s])||(i[s]=[]),i[s].push(c)):i[s]??(i[s]=c)}return e?i[e]:i},nr=ke,ir=(t,e)=>ke(t,e,!0),Xt=decodeURIComponent,oe=t=>Ht(t,Xt),dt,S,H,Ce,Ae,Vt,N,be,_e=(be=class{constructor(t,e="/",r=[[]]){m(this,H);g(this,"raw");m(this,dt);m(this,S);g(this,"routeIndex",0);g(this,"path");g(this,"bodyCache",{});m(this,N,t=>{const{bodyCache:e,raw:r}=this,n=e[t];if(n)return n;const i=Object.keys(e)[0];return i?e[i].then(o=>(i==="json"&&(o=JSON.stringify(o)),new Response(o)[t]())):e[t]=r[t]()});this.raw=t,this.path=e,h(this,S,r),h(this,dt,{})}param(t){return t?v(this,H,Ce).call(this,t):v(this,H,Ae).call(this)}query(t){return nr(this.url,t)}queries(t){return ir(this.url,t)}header(t){if(t)return this.raw.headers.get(t)??void 0;const e={};return this.raw.headers.forEach((r,n)=>{e[n]=r}),e}async parseBody(t){return We(this,t)}json(){return p(this,N).call(this,"text").then(t=>JSON.parse(t))}text(){return p(this,N).call(this,"text")}arrayBuffer(){return p(this,N).call(this,"arrayBuffer")}blob(){return p(this,N).call(this,"blob")}formData(){return p(this,N).call(this,"formData")}addValidatedData(t,e){p(this,dt)[t]=e}valid(t){return p(this,dt)[t]}get url(){return this.raw.url}get method(){return this.raw.method}get[qe](){return p(this,S)}get matchedRoutes(){return p(this,S)[0].map(([[,t]])=>t)}get routePath(){return p(this,S)[0].map(([[,t]])=>t)[this.routeIndex].path}},dt=new WeakMap,S=new WeakMap,H=new WeakSet,Ce=function(t){const e=p(this,S)[0][this.routeIndex][1][t],r=v(this,H,Vt).call(this,e);return r&&/\%/.test(r)?oe(r):r},Ae=function(){const t={},e=Object.keys(p(this,S)[0][this.routeIndex][1]);for(const r of e){const n=v(this,H,Vt).call(this,p(this,S)[0][this.routeIndex][1][r]);n!==void 0&&(t[r]=/\%/.test(n)?oe(n):n)}return t},Vt=function(t){return p(this,S)[1]?p(this,S)[1][t]:t},N=new WeakMap,be),or={Stringify:1},De=async(t,e,r,n,i)=>{typeof t=="object"&&!(t instanceof String)&&(t instanceof Promise||(t=t.toString()),t instanceof Promise&&(t=await t));const o=t.callbacks;return o!=null&&o.length?(i?i[0]+=t:i=[t],Promise.all(o.map(l=>l({phase:e,buffer:i,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(s=>De(s,e,!1,n,i))).then(()=>i[0]))):Promise.resolve(t)},ar="text/plain; charset=UTF-8",Yt=(t,e)=>({"Content-Type":t,...e}),$t=(t,e)=>new Response(t,e),_t,Ct,j,ut,L,D,At,ft,ht,Z,Dt,St,G,ct,me,sr=(me=class{constructor(t,e){m(this,G);m(this,_t);m(this,Ct);g(this,"env",{});m(this,j);g(this,"finalized",!1);g(this,"error");m(this,ut);m(this,L);m(this,D);m(this,At);m(this,ft);m(this,ht);m(this,Z);m(this,Dt);m(this,St);g(this,"render",(...t)=>(p(this,ft)??h(this,ft,e=>this.html(e)),p(this,ft).call(this,...t)));g(this,"setLayout",t=>h(this,At,t));g(this,"getLayout",()=>p(this,At));g(this,"setRenderer",t=>{h(this,ft,t)});g(this,"header",(t,e,r)=>{this.finalized&&h(this,D,$t(p(this,D).body,p(this,D)));const n=p(this,D)?p(this,D).headers:p(this,Z)??h(this,Z,new Headers);e===void 0?n.delete(t):r!=null&&r.append?n.append(t,e):n.set(t,e)});g(this,"status",t=>{h(this,ut,t)});g(this,"set",(t,e)=>{p(this,j)??h(this,j,new Map),p(this,j).set(t,e)});g(this,"get",t=>p(this,j)?p(this,j).get(t):void 0);g(this,"newResponse",(...t)=>v(this,G,ct).call(this,...t));g(this,"body",(t,e,r)=>v(this,G,ct).call(this,t,e,r));g(this,"text",(t,e,r)=>!p(this,Z)&&!p(this,ut)&&!e&&!r&&!this.finalized?new Response(t):v(this,G,ct).call(this,t,e,Yt(ar,r)));g(this,"json",(t,e,r)=>v(this,G,ct).call(this,JSON.stringify(t),e,Yt("application/json",r)));g(this,"html",(t,e,r)=>{const n=i=>v(this,G,ct).call(this,i,e,Yt("text/html; charset=UTF-8",r));return typeof t=="object"?De(t,or.Stringify,!1,{}).then(n):n(t)});g(this,"redirect",(t,e)=>{const r=String(t);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,e??302)});g(this,"notFound",()=>(p(this,ht)??h(this,ht,()=>$t()),p(this,ht).call(this,this)));h(this,_t,t),e&&(h(this,L,e.executionCtx),this.env=e.env,h(this,ht,e.notFoundHandler),h(this,St,e.path),h(this,Dt,e.matchResult))}get req(){return p(this,Ct)??h(this,Ct,new _e(p(this,_t),p(this,St),p(this,Dt))),p(this,Ct)}get event(){if(p(this,L)&&"respondWith"in p(this,L))return p(this,L);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,L))return p(this,L);throw Error("This context has no ExecutionContext")}get res(){return p(this,D)||h(this,D,$t(null,{headers:p(this,Z)??h(this,Z,new Headers)}))}set res(t){if(p(this,D)&&t){t=$t(t.body,t);for(const[e,r]of p(this,D).headers.entries())if(e!=="content-type")if(e==="set-cookie"){const n=p(this,D).headers.getSetCookie();t.headers.delete("set-cookie");for(const i of n)t.headers.append("set-cookie",i)}else t.headers.set(e,r)}h(this,D,t),this.finalized=!0}get var(){return p(this,j)?Object.fromEntries(p(this,j)):{}}},_t=new WeakMap,Ct=new WeakMap,j=new WeakMap,ut=new WeakMap,L=new WeakMap,D=new WeakMap,At=new WeakMap,ft=new WeakMap,ht=new WeakMap,Z=new WeakMap,Dt=new WeakMap,St=new WeakMap,G=new WeakSet,ct=function(t,e,r){const n=p(this,D)?new Headers(p(this,D).headers):p(this,Z)??new Headers;if(typeof e=="object"&&"headers"in e){const o=e.headers instanceof Headers?e.headers:new Headers(e.headers);for(const[a,l]of o)a.toLowerCase()==="set-cookie"?n.append(a,l):n.set(a,l)}if(r)for(const[o,a]of Object.entries(r))if(typeof a=="string")n.set(o,a);else{n.delete(o);for(const l of a)n.append(o,l)}const i=typeof e=="number"?e:(e==null?void 0:e.status)??p(this,ut);return $t(t,{status:i,headers:n})},me),E="ALL",lr="all",cr=["get","post","put","delete","options","patch"],Se="Can not add a route since the matcher is already built.",Oe=class extends Error{},pr="__COMPOSED_HANDLER",dr=t=>t.text("404 Not Found",404),ae=(t,e)=>{if("getResponse"in t){const r=t.getResponse();return e.newResponse(r.body,r)}return console.error(t),e.text("Internal Server Error",500)},B,k,Be,R,X,Tt,It,gt,ur=(gt=class{constructor(e={}){m(this,k);g(this,"get");g(this,"post");g(this,"put");g(this,"delete");g(this,"options");g(this,"patch");g(this,"all");g(this,"on");g(this,"use");g(this,"router");g(this,"getPath");g(this,"_basePath","/");m(this,B,"/");g(this,"routes",[]);m(this,R,dr);g(this,"errorHandler",ae);g(this,"onError",e=>(this.errorHandler=e,this));g(this,"notFound",e=>(h(this,R,e),this));g(this,"fetch",(e,...r)=>v(this,k,It).call(this,e,r[1],r[0],e.method));g(this,"request",(e,r,n,i)=>e instanceof Request?this.fetch(r?new Request(e,r):e,n,i):(e=e.toString(),this.fetch(new Request(/^https?:\/\//.test(e)?e:`http://localhost${lt("/",e)}`,r),n,i)));g(this,"fire",()=>{addEventListener("fetch",e=>{e.respondWith(v(this,k,It).call(this,e.request,e,void 0,e.request.method))})});[...cr,lr].forEach(o=>{this[o]=(a,...l)=>(typeof a=="string"?h(this,B,a):v(this,k,X).call(this,o,p(this,B),a),l.forEach(s=>{v(this,k,X).call(this,o,p(this,B),s)}),this)}),this.on=(o,a,...l)=>{for(const s of[a].flat()){h(this,B,s);for(const c of[o].flat())l.map(d=>{v(this,k,X).call(this,c.toUpperCase(),p(this,B),d)})}return this},this.use=(o,...a)=>(typeof o=="string"?h(this,B,o):(h(this,B,"*"),a.unshift(o)),a.forEach(l=>{v(this,k,X).call(this,E,p(this,B),l)}),this);const{strict:n,...i}=e;Object.assign(this,i),this.getPath=n??!0?e.getPath??Fe:rr}route(e,r){const n=this.basePath(e);return r.routes.map(i=>{var a;let o;r.errorHandler===ae?o=i.handler:(o=async(l,s)=>(await ie([],r.errorHandler)(l,()=>i.handler(l,s))).res,o[pr]=i.handler),v(a=n,k,X).call(a,i.method,i.path,o)}),this}basePath(e){const r=v(this,k,Be).call(this);return r._basePath=lt(this._basePath,e),r}mount(e,r,n){let i,o;n&&(typeof n=="function"?o=n:(o=n.optionHandler,n.replaceRequest===!1?i=s=>s:i=n.replaceRequest));const a=o?s=>{const c=o(s);return Array.isArray(c)?c:[c]}:s=>{let c;try{c=s.executionCtx}catch{}return[s.env,c]};i||(i=(()=>{const s=lt(this._basePath,e),c=s==="/"?0:s.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const l=async(s,c)=>{const d=await r(i(s.req.raw),...a(s));if(d)return d;await c()};return v(this,k,X).call(this,E,lt(e,"*"),l),this}},B=new WeakMap,k=new WeakSet,Be=function(){const e=new gt({router:this.router,getPath:this.getPath});return e.errorHandler=this.errorHandler,h(e,R,p(this,R)),e.routes=this.routes,e},R=new WeakMap,X=function(e,r,n){e=e.toUpperCase(),r=lt(this._basePath,r);const i={basePath:this._basePath,path:r,method:e,handler:n};this.router.add(e,r,[n,i]),this.routes.push(i)},Tt=function(e,r){if(e instanceof Error)return this.errorHandler(e,r);throw e},It=function(e,r,n,i){if(i==="HEAD")return(async()=>new Response(null,await v(this,k,It).call(this,e,r,n,"GET")))();const o=this.getPath(e,{env:n}),a=this.router.match(i,o),l=new sr(e,{path:o,matchResult:a,env:n,executionCtx:r,notFoundHandler:p(this,R)});if(a[0].length===1){let c;try{c=a[0][0][0][0](l,async()=>{l.res=await p(this,R).call(this,l)})}catch(d){return v(this,k,Tt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:p(this,R).call(this,l))).catch(d=>v(this,k,Tt).call(this,d,l)):c??p(this,R).call(this,l)}const s=ie(a[0],this.errorHandler,p(this,R));return(async()=>{try{const c=await s(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return v(this,k,Tt).call(this,c,l)}})()},gt),Re=[];function fr(t,e){const r=this.buildAllMatchers(),n=((i,o)=>{const a=r[i]||r[E],l=a[2][o];if(l)return l;const s=o.match(a[0]);if(!s)return[[],Re];const c=s.indexOf("",1);return[a[1][c],s]});return this.match=n,n(t,e)}var Lt="[^/]+",Et=".*",kt="(?:|/.*)",pt=Symbol(),hr=new Set(".\\+*[^]$()");function gr(t,e){return t.length===1?e.length===1?t<e?-1:1:-1:e.length===1||t===Et||t===kt?1:e===Et||e===kt?-1:t===Lt?1:e===Lt?-1:t.length===e.length?t<e?-1:1:e.length-t.length}var Q,tt,T,nt,br=(nt=class{constructor(){m(this,Q);m(this,tt);m(this,T,Object.create(null))}insert(e,r,n,i,o){if(e.length===0){if(p(this,Q)!==void 0)throw pt;if(o)return;h(this,Q,r);return}const[a,...l]=e,s=a==="*"?l.length===0?["","",Et]:["","",Lt]:a==="/*"?["","",kt]:a.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(s){const d=s[1];let u=s[2]||Lt;if(d&&s[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw pt;if(c=p(this,T)[u],!c){if(Object.keys(p(this,T)).some(f=>f!==Et&&f!==kt))throw pt;if(o)return;c=p(this,T)[u]=new nt,d!==""&&h(c,tt,i.varIndex++)}!o&&d!==""&&n.push([d,p(c,tt)])}else if(c=p(this,T)[a],!c){if(Object.keys(p(this,T)).some(d=>d.length>1&&d!==Et&&d!==kt))throw pt;if(o)return;c=p(this,T)[a]=new nt}c.insert(l,r,n,i,o)}buildRegExpStr(){const r=Object.keys(p(this,T)).sort(gr).map(n=>{const i=p(this,T)[n];return(typeof p(i,tt)=="number"?`(${n})@${p(i,tt)}`:hr.has(n)?`\\${n}`:n)+i.buildRegExpStr()});return typeof p(this,Q)=="number"&&r.unshift(`#${p(this,Q)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Q=new WeakMap,tt=new WeakMap,T=new WeakMap,nt),zt,Ot,xe,mr=(xe=class{constructor(){m(this,zt,{varIndex:0});m(this,Ot,new br)}insert(t,e,r){const n=[],i=[];for(let a=0;;){let l=!1;if(t=t.replace(/\{[^}]+\}/g,s=>{const c=`@\\${a}`;return i[a]=[c,s],a++,l=!0,c}),!l)break}const o=t.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let a=i.length-1;a>=0;a--){const[l]=i[a];for(let s=o.length-1;s>=0;s--)if(o[s].indexOf(l)!==-1){o[s]=o[s].replace(l,i[a][1]);break}}return p(this,Ot).insert(o,e,n,p(this,zt),r),n}buildRegExp(){let t=p(this,Ot).buildRegExpStr();if(t==="")return[/^$/,[],[]];let e=0;const r=[],n=[];return t=t.replace(/#(\d+)|@(\d+)|\.\*\$/g,(i,o,a)=>o!==void 0?(r[++e]=Number(o),"$()"):(a!==void 0&&(n[Number(a)]=++e),"")),[new RegExp(`^${t}`),r,n]}},zt=new WeakMap,Ot=new WeakMap,xe),xr=[/^$/,[],Object.create(null)],jt=Object.create(null);function Te(t){return jt[t]??(jt[t]=new RegExp(t==="*"?"":`^${t.replace(/\/\*$|([.\\+*[^\]$()])/g,(e,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function yr(){jt=Object.create(null)}function wr(t){var c;const e=new mr,r=[];if(t.length===0)return xr;const n=t.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[f,y])=>d?1:f?-1:u.length-y.length),i=Object.create(null);for(let d=0,u=-1,f=n.length;d<f;d++){const[y,b,x]=n[d];y?i[b]=[x.map(([_])=>[_,Object.create(null)]),Re]:u++;let F;try{F=e.insert(b,u,y)}catch(_){throw _===pt?new Oe(b):_}y||(r[u]=x.map(([_,$])=>{const O=Object.create(null);for($-=1;$>=0;$--){const[J,Gt]=F[$];O[J]=Gt}return[_,O]}))}const[o,a,l]=e.buildRegExp();for(let d=0,u=r.length;d<u;d++)for(let f=0,y=r[d].length;f<y;f++){const b=(c=r[d][f])==null?void 0:c[1];if(!b)continue;const x=Object.keys(b);for(let F=0,_=x.length;F<_;F++)b[x[F]]=l[b[x[F]]]}const s=[];for(const d in a)s[d]=r[a[d]];return[o,s,i]}function st(t,e){if(t){for(const r of Object.keys(t).sort((n,i)=>i.length-n.length))if(Te(r).test(e))return[...t[r]]}}var U,q,Pt,Ie,ye,vr=(ye=class{constructor(){m(this,Pt);g(this,"name","RegExpRouter");m(this,U);m(this,q);g(this,"match",fr);h(this,U,{[E]:Object.create(null)}),h(this,q,{[E]:Object.create(null)})}add(t,e,r){var l;const n=p(this,U),i=p(this,q);if(!n||!i)throw new Error(Se);n[t]||[n,i].forEach(s=>{s[t]=Object.create(null),Object.keys(s[E]).forEach(c=>{s[t][c]=[...s[E][c]]})}),e==="/*"&&(e="*");const o=(e.match(/\/:/g)||[]).length;if(/\*$/.test(e)){const s=Te(e);t===E?Object.keys(n).forEach(c=>{var d;(d=n[c])[e]||(d[e]=st(n[c],e)||st(n[E],e)||[])}):(l=n[t])[e]||(l[e]=st(n[t],e)||st(n[E],e)||[]),Object.keys(n).forEach(c=>{(t===E||t===c)&&Object.keys(n[c]).forEach(d=>{s.test(d)&&n[c][d].push([r,o])})}),Object.keys(i).forEach(c=>{(t===E||t===c)&&Object.keys(i[c]).forEach(d=>s.test(d)&&i[c][d].push([r,o]))});return}const a=Ee(e)||[e];for(let s=0,c=a.length;s<c;s++){const d=a[s];Object.keys(i).forEach(u=>{var f;(t===E||t===u)&&((f=i[u])[d]||(f[d]=[...st(n[u],d)||st(n[E],d)||[]]),i[u][d].push([r,o-c+s+1]))})}}buildAllMatchers(){const t=Object.create(null);return Object.keys(p(this,q)).concat(Object.keys(p(this,U))).forEach(e=>{t[e]||(t[e]=v(this,Pt,Ie).call(this,e))}),h(this,U,h(this,q,void 0)),yr(),t}},U=new WeakMap,q=new WeakMap,Pt=new WeakSet,Ie=function(t){const e=[];let r=t===E;return[p(this,U),p(this,q)].forEach(n=>{const i=n[t]?Object.keys(n[t]).map(o=>[o,n[t][o]]):[];i.length!==0?(r||(r=!0),e.push(...i)):t!==E&&e.push(...Object.keys(n[E]).map(o=>[o,n[E][o]]))}),r?wr(e):null},ye),W,z,we,$r=(we=class{constructor(t){g(this,"name","SmartRouter");m(this,W,[]);m(this,z,[]);h(this,W,t.routers)}add(t,e,r){if(!p(this,z))throw new Error(Se);p(this,z).push([t,e,r])}match(t,e){if(!p(this,z))throw new Error("Fatal error");const r=p(this,W),n=p(this,z),i=r.length;let o=0,a;for(;o<i;o++){const l=r[o];try{for(let s=0,c=n.length;s<c;s++)l.add(...n[s]);a=l.match(t,e)}catch(s){if(s instanceof Oe)continue;throw s}this.match=l.match.bind(l),h(this,W,[l]),h(this,z,void 0);break}if(o===i)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,a}get activeRouter(){if(p(this,z)||p(this,W).length!==1)throw new Error("No active router has been determined yet.");return p(this,W)[0]}},W=new WeakMap,z=new WeakMap,we),Ft=Object.create(null),Fr=t=>{for(const e in t)return!0;return!1},Y,A,et,bt,C,P,K,mt,Er=(mt=class{constructor(e,r,n){m(this,P);m(this,Y);m(this,A);m(this,et);m(this,bt,0);m(this,C,Ft);if(h(this,A,n||Object.create(null)),h(this,Y,[]),e&&r){const i=Object.create(null);i[e]={handler:r,possibleKeys:[],score:0},h(this,Y,[i])}h(this,et,[])}insert(e,r,n){h(this,bt,++ne(this,bt)._);let i=this;const o=Ke(r),a=[];for(let l=0,s=o.length;l<s;l++){const c=o[l],d=o[l+1],u=tr(c,d),f=Array.isArray(u)?u[0]:c;if(f in p(i,A)){i=p(i,A)[f],u&&a.push(u[1]);continue}p(i,A)[f]=new mt,u&&(p(i,et).push(u),a.push(u[1])),i=p(i,A)[f]}return p(i,Y).push({[e]:{handler:n,possibleKeys:a.filter((l,s,c)=>c.indexOf(l)===s),score:p(this,bt)}}),i}search(e,r){var d;const n=[];h(this,C,Ft);let o=[this];const a=$e(r),l=[],s=a.length;let c=null;for(let u=0;u<s;u++){const f=a[u],y=u===s-1,b=[];for(let F=0,_=o.length;F<_;F++){const $=o[F],O=p($,A)[f];O&&(h(O,C,p($,C)),y?(p(O,A)["*"]&&v(this,P,K).call(this,n,p(O,A)["*"],e,p($,C)),v(this,P,K).call(this,n,O,e,p($,C))):b.push(O));for(let J=0,Gt=p($,et).length;J<Gt;J++){const te=p($,et)[J],M=p($,C)===Ft?{}:{...p($,C)};if(te==="*"){const ot=p($,A)["*"];ot&&(v(this,P,K).call(this,n,ot,e,p($,C)),h(ot,C,M),b.push(ot));continue}const[Ne,ee,wt]=te;if(!f&&!(wt instanceof RegExp))continue;const I=p($,A)[Ne];if(wt instanceof RegExp){if(c===null){c=new Array(s);let at=r[0]==="/"?1:0;for(let vt=0;vt<s;vt++)c[vt]=at,at+=a[vt].length+1}const ot=r.substring(c[u]),Ut=wt.exec(ot);if(Ut){if(M[ee]=Ut[0],v(this,P,K).call(this,n,I,e,p($,C),M),Fr(p(I,A))){h(I,C,M);const at=((d=Ut[0].match(/\//))==null?void 0:d.length)??0;(l[at]||(l[at]=[])).push(I)}continue}}(wt===!0||wt.test(f))&&(M[ee]=f,y?(v(this,P,K).call(this,n,I,e,M,p($,C)),p(I,A)["*"]&&v(this,P,K).call(this,n,p(I,A)["*"],e,M,p($,C))):(h(I,C,M),b.push(I)))}}const x=l.shift();o=x?b.concat(x):b}return n.length>1&&n.sort((u,f)=>u.score-f.score),[n.map(({handler:u,params:f})=>[u,f])]}},Y=new WeakMap,A=new WeakMap,et=new WeakMap,bt=new WeakMap,C=new WeakMap,P=new WeakSet,K=function(e,r,n,i,o){for(let a=0,l=p(r,Y).length;a<l;a++){const s=p(r,Y)[a],c=s[n]||s[E],d={};if(c!==void 0&&(c.params=Object.create(null),e.push(c),i!==Ft||o&&o!==Ft))for(let u=0,f=c.possibleKeys.length;u<f;u++){const y=c.possibleKeys[u],b=d[c.score];c.params[y]=o!=null&&o[y]&&!b?o[y]:i[y]??(o==null?void 0:o[y]),d[c.score]=!0}}},mt),rt,ve,kr=(ve=class{constructor(){g(this,"name","TrieRouter");m(this,rt);h(this,rt,new Er)}add(t,e,r){const n=Ee(e);if(n){for(let i=0,o=n.length;i<o;i++)p(this,rt).insert(t,n[i],r);return}p(this,rt).insert(t,e,r)}match(t,e){return p(this,rt).search(t,e)}},rt=new WeakMap,ve),je=class extends ur{constructor(t={}){super(t),this.router=t.router??new $r({routers:[new vr,new kr]})}},_r=t=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...t},n=(o=>typeof o=="string"?o==="*"?r.credentials?a=>a||null:()=>o:a=>o===a?a:null:typeof o=="function"?o:a=>o.includes(a)?a:null)(r.origin),i=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(r.allowMethods);return async function(a,l){var d;function s(u,f){a.res.headers.set(u,f)}const c=await n(a.req.header("origin")||"",a);if(c&&s("Access-Control-Allow-Origin",c),r.credentials&&s("Access-Control-Allow-Credentials","true"),(d=r.exposeHeaders)!=null&&d.length&&s("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),a.req.method==="OPTIONS"){(r.origin!=="*"||r.credentials)&&s("Vary","Origin"),r.maxAge!=null&&s("Access-Control-Max-Age",r.maxAge.toString());const u=await i(a.req.header("origin")||"",a);u.length&&s("Access-Control-Allow-Methods",u.join(","));let f=r.allowHeaders;if(!(f!=null&&f.length)){const y=a.req.header("Access-Control-Request-Headers");y&&(f=y.split(/\s*,\s*/))}return f!=null&&f.length&&(s("Access-Control-Allow-Headers",f.join(",")),a.res.headers.append("Vary","Access-Control-Request-Headers")),a.res.headers.delete("Content-Length"),a.res.headers.delete("Content-Type"),new Response(null,{headers:a.res.headers,status:204,statusText:"No Content"})}await l(),(r.origin!=="*"||r.credentials)&&a.header("Vary","Origin",{append:!0})}},Cr={crossOriginEmbedderPolicy:["Cross-Origin-Embedder-Policy","require-corp"],crossOriginResourcePolicy:["Cross-Origin-Resource-Policy","same-origin"],crossOriginOpenerPolicy:["Cross-Origin-Opener-Policy","same-origin"],originAgentCluster:["Origin-Agent-Cluster","?1"],referrerPolicy:["Referrer-Policy","no-referrer"],strictTransportSecurity:["Strict-Transport-Security","max-age=15552000; includeSubDomains"],xContentTypeOptions:["X-Content-Type-Options","nosniff"],xDnsPrefetchControl:["X-DNS-Prefetch-Control","off"],xDownloadOptions:["X-Download-Options","noopen"],xFrameOptions:["X-Frame-Options","SAMEORIGIN"],xPermittedCrossDomainPolicies:["X-Permitted-Cross-Domain-Policies","none"],xXssProtection:["X-XSS-Protection","0"]},Ar={crossOriginEmbedderPolicy:!1,crossOriginResourcePolicy:!0,crossOriginOpenerPolicy:!0,originAgentCluster:!0,referrerPolicy:!0,strictTransportSecurity:!0,xContentTypeOptions:!0,xDnsPrefetchControl:!0,xDownloadOptions:!0,xFrameOptions:!0,xPermittedCrossDomainPolicies:!0,xXssProtection:!0,removePoweredBy:!0,permissionsPolicy:{}},Dr=t=>{const e={...Ar,...t},r=Sr(e),n=[];if(e.contentSecurityPolicy){const[i,o]=se(e.contentSecurityPolicy);i&&n.push(i),r.push(["Content-Security-Policy",o])}if(e.contentSecurityPolicyReportOnly){const[i,o]=se(e.contentSecurityPolicyReportOnly);i&&n.push(i),r.push(["Content-Security-Policy-Report-Only",o])}return e.permissionsPolicy&&Object.keys(e.permissionsPolicy).length>0&&r.push(["Permissions-Policy",Or(e.permissionsPolicy)]),e.reportingEndpoints&&r.push(["Reporting-Endpoints",Rr(e.reportingEndpoints)]),e.reportTo&&r.push(["Report-To",Tr(e.reportTo)]),async function(o,a){const l=n.length===0?r:n.reduce((s,c)=>c(o,s),r);await a(),Ir(o,l),e!=null&&e.removePoweredBy&&o.res.headers.delete("X-Powered-By")}};function Sr(t){return Object.entries(Cr).filter(([e])=>t[e]).map(([e,r])=>{const n=t[e];return typeof n=="string"?[r[0],n]:r})}function se(t){const e=[],r=[];for(const[n,i]of Object.entries(t)){const o=Array.isArray(i)?i:[i];o.forEach((a,l)=>{if(typeof a=="function"){const s=l*2+2+r.length;e.push((c,d)=>{d[s]=a(c,n)})}}),r.push(n.replace(/[A-Z]+(?![a-z])|[A-Z]/g,(a,l)=>l?"-"+a.toLowerCase():a.toLowerCase()),...o.flatMap(a=>[" ",a]),"; ")}return r.pop(),e.length===0?[void 0,r.join("")]:[(n,i)=>i.map(o=>{if(o[0]==="Content-Security-Policy"||o[0]==="Content-Security-Policy-Report-Only"){const a=o[1].slice();return e.forEach(l=>{l(n,a)}),[o[0],a.join("")]}else return o}),r]}function Or(t){return Object.entries(t).map(([e,r])=>{const n=Br(e);if(typeof r=="boolean")return`${n}=${r?"*":"none"}`;if(Array.isArray(r)){if(r.length===0)return`${n}=()`;if(r.length===1&&(r[0]==="*"||r[0]==="none"))return`${n}=${r[0]}`;const i=r.map(o=>["self","src"].includes(o)?o:`"${o}"`);return`${n}=(${i.join(" ")})`}return""}).filter(Boolean).join(", ")}function Br(t){return t.replace(/([a-z\d])([A-Z])/g,"$1-$2").toLowerCase()}function Rr(t=[]){return t.map(e=>`${e.name}="${e.url}"`).join(", ")}function Tr(t=[]){return t.map(e=>JSON.stringify(e)).join(", ")}function Ir(t,e){e.forEach(([r,n])=>{t.res.headers.set(r,n)})}function jr(){const{process:t,Deno:e}=globalThis;return!(typeof(e==null?void 0:e.noColor)=="boolean"?e.noColor:t!==void 0?"NO_COLOR"in(t==null?void 0:t.env):!1)}async function Lr(){const{navigator:t}=globalThis,e="cloudflare:workers";return!(t!==void 0&&t.userAgent==="Cloudflare-Workers"?await(async()=>{try{return"NO_COLOR"in((await import(e)).env??{})}catch{return!1}})():!jr())}var zr=t=>{const[e,r]=[",","."];return t.map(i=>i.replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1"+e)).join(r)},Pr=t=>{const e=Date.now()-t;return zr([e<1e3?e+"ms":Math.round(e/1e3)+"s"])},Hr=async t=>{if(await Lr())switch(t/100|0){case 5:return`\x1B[31m${t}\x1B[0m`;case 4:return`\x1B[33m${t}\x1B[0m`;case 3:return`\x1B[36m${t}\x1B[0m`;case 2:return`\x1B[32m${t}\x1B[0m`}return`${t}`};async function le(t,e,r,n,i=0,o){const a=e==="<--"?`${e} ${r} ${n}`:`${e} ${r} ${n} ${await Hr(i)} ${o}`;t(a)}var Mr=(t=console.log)=>async function(r,n){const{method:i,url:o}=r.req,a=o.slice(o.indexOf("/",8));await le(t,"<--",i,a);const l=Date.now();await n(),await le(t,"-->",i,a,r.res.status,Pr(l))},Le=/^[\w!#$%&'*.^`|~+-]+$/,Nr=/^[ !#-:<-[\]-~]*$/,ce=t=>{let e=0,r=t.length;for(;e<r;){const n=t.charCodeAt(e);if(n!==32&&n!==9)break;e++}for(;r>e;){const n=t.charCodeAt(r-1);if(n!==32&&n!==9)break;r--}return e===0&&r===t.length?t:t.slice(e,r)},Gr=(t,e)=>{if(t.indexOf(e)===-1)return{};const r=t.split(";"),n={};for(const i of r){const o=i.indexOf("=");if(o===-1)continue;const a=ce(i.substring(0,o));if(e!==a||!Le.test(a))continue;let l=ce(i.substring(o+1));if(l.startsWith('"')&&l.endsWith('"')&&(l=l.slice(1,-1)),Nr.test(l)){n[a]=l.indexOf("%")!==-1?Ht(l,Xt):l;break}}return n},Ur=(t,e,r={})=>{if(!Le.test(t))throw new Error("Invalid cookie name");let n=`${t}=${e}`;if(t.startsWith("__Secure-")&&!r.secure)throw new Error("__Secure- Cookie must have Secure attributes");if(t.startsWith("__Host-")){if(!r.secure)throw new Error("__Host- Cookie must have Secure attributes");if(r.path!=="/")throw new Error('__Host- Cookie must have Path attributes with "/"');if(r.domain)throw new Error("__Host- Cookie must not have Domain attributes")}for(const i of["domain","path"])if(r[i]&&/[;\r\n]/.test(r[i]))throw new Error(`${i} must not contain ";", "\\r", or "\\n"`);if(r&&typeof r.maxAge=="number"&&r.maxAge>=0){if(r.maxAge>3456e4)throw new Error("Cookies Max-Age SHOULD NOT be greater than 400 days (34560000 seconds) in duration.");n+=`; Max-Age=${r.maxAge|0}`}if(r.domain&&r.prefix!=="host"&&(n+=`; Domain=${r.domain}`),r.path&&(n+=`; Path=${r.path}`),r.expires){if(r.expires.getTime()-Date.now()>3456e7)throw new Error("Cookies Expires SHOULD NOT be greater than 400 days (34560000 seconds) in the future.");n+=`; Expires=${r.expires.toUTCString()}`}if(r.httpOnly&&(n+="; HttpOnly"),r.secure&&(n+="; Secure"),r.sameSite&&(n+=`; SameSite=${r.sameSite.charAt(0).toUpperCase()+r.sameSite.slice(1)}`),r.priority&&(n+=`; Priority=${r.priority.charAt(0).toUpperCase()+r.priority.slice(1)}`),r.partitioned){if(!r.secure)throw new Error("Partitioned Cookie must have Secure attributes");n+="; Partitioned"}return n},Jt=(t,e,r)=>(e=encodeURIComponent(e),Ur(t,e,r)),Kt=(t,e,r)=>{const n=t.req.raw.headers.get("Cookie");{if(!n)return;let i=e;return Gr(n,i)[i]}},qr=(t,e,r)=>{let n;return(r==null?void 0:r.prefix)==="secure"?n=Jt("__Secure-"+t,e,{path:"/",...r,secure:!0}):(r==null?void 0:r.prefix)==="host"?n=Jt("__Host-"+t,e,{...r,path:"/",secure:!0,domain:void 0}):n=Jt(t,e,{path:"/",...r}),n},Wr=(t,e,r,n)=>{const i=qr(e,r,n);t.header("Set-Cookie",i,{append:!0})};const Yr={joy:["嬉しい","うれしい","楽しい","たのしい","幸せ","しあわせ","喜び","よろこび","最高","さいこう","ハッピー","happy","笑","わら","ニコニコ","にこにこ","すごい","すげー","やったー","やった","わくわく","ワクワク","ウキウキ","うきうき","ご機嫌","満足","まんぞく","ラッキー","ありがとう","感謝","かんしゃ","大好き","だいすき","成功","せいこう","勝った","クリア","達成","たっせい","面白い","おもしろい","最高","かわいい","可愛い","綺麗","きれい","美味しい","おいしい"],sadness:["悲しい","かなしい","つらい","辛い","寂しい","さびしい","涙","なみだ","泣","な","切ない","sad","落ち込","おちこ","憂鬱","ゆううつ","虚しい","むなしい","孤独","こどく","失った","失敗","しっぱい","後悔","こうかい","残念","ざんねん","がっかり","ガッカリ","凹","へこ","疲れ","つかれ","しんどい","きつい","嫌","いや","だめ","ダメ","終わった","むり","無理","病んで"],anger:["怒","おこ","イライラ","いらいら","ムカつく","むかつく","腹立","はらだ","うざい","ウザい","angry","キレ","きれ","許せない","ゆるせない","最悪","さいあく","クソ","くそ","ふざけ","ぶちぎれ","ブチギレ","激怒","げきど","憎","にく","頭にきた","ありえない","クズ","ばか","バカ","うるさい"],fear:["怖い","こわい","不安","ふあん","心配","しんぱい","緊張","きんちょう","ドキドキ","どきどき","fear","scared","ビビ","びび","恐怖","きょうふ","焦","あせ","逃げ","にげ","震え","ふるえ","やばい","ヤバい","危ない","あぶない","嫌だ","どうしよう","どうしたら","失敗したら"],love:["好き","すき","大好き","だいすき","愛","あい","恋","こい","love","ラブ","ハート","胸キュン","ときめき","トキメキ","片想い","片思い","両思い","付き合","つきあ","彼氏","彼女","カップル","デート","プロポーズ","結婚","けっこん","大切","たいせつ","宝物","たからもの","一生","永遠"],surprise:["びっくり","ビックリ","驚","おどろ","まじ","マジ","え！","えっ","うそ","ウソ","嘘","まさか","ありえ","信じられ","しんじられ","surprise","wow","すごっ","ぎゃー","ギャー","どっひゃ","衝撃","しょうげき","予想外","よそうがい","ハッとした","ハッと"],calm:["落ち着","おちつ","穏やか","おだやか","静か","しずか","安心","あんしん","ゆったり","のんびり","まったり","癒","いや","リラックス","calm","peaceful","心地よい","ここちよい","幸福","こうふく","平和","へいわ","普通","ふつう","まあまあ","大丈夫","だいじょうぶ","okay","OK","いい感じ"]},Jr=["とても","すごく","超","めちゃ","めっちゃ","ものすごく","本当に","ほんとに","まじで","マジで","激","very","really","so","!","！"],Vr=["ない","じゃない","ではない","じゃなかった","not","no"];function Xr(t){const e=t.toLowerCase(),r={joy:0,sadness:0,anger:0,fear:0,love:0,surprise:0,calm:0};for(const[b,x]of Object.entries(Yr))for(const F of x){let _=0,$=0;for(;(_=e.indexOf(F,_))!==-1;)$++,_+=F.length;r[b]+=$}let n=.3;for(const b of Jr){const x=(e.match(new RegExp(b.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),"g"))||[]).length;n+=x*.15}n=Math.min(1,n);const i=(t.match(/[!！]/g)||[]).length;n=Math.min(1,n+i*.1),Vr.reduce((b,x)=>b+(e.match(new RegExp(x,"g"))||[]).length,0)>0&&r.joy>0&&(r.sadness+=r.joy*.3,r.joy*=.5);let a="calm",l=0;for(const[b,x]of Object.entries(r))x>l&&(l=x,a=b);const s=t.length,c=Math.min(1,s/50);l===0&&(a="calm",n=.4);const d=Object.values(r).sort((b,x)=>x-b),u=d[0]-(d[1]||0),f=d.reduce((b,x)=>b+x,0),y=f>0?Math.min(1,.5+u/f*.5)*c+.2:.4;return{emotion:a,score:Math.min(1,y),scores:r,intensity:n}}const Kr={joy:{primary:["#FFD93D","#FFB84D","#FFA07A","#FFE066","#FFC857"],secondary:["#FF6B6B","#FF9F1C","#F4D35E","#FFEDB5"]},sadness:{primary:["#6B9DC2","#5B8DC4","#4A6FA5","#7BA7BC","#8DAFCC"],secondary:["#A8DADC","#B8E0D2","#9FC5E8","#CDD7D6"]},anger:{primary:["#E63946","#D62828","#FF4D4D","#C9302C","#E53E3E"],secondary:["#F77F00","#FCA311","#FF6B35","#FF8C42"]},fear:{primary:["#6A4C93","#7B2CBF","#5A189A","#9D4EDD","#7251B5"],secondary:["#3A0CA3","#480CA8","#560BAD","#B5179E"]},love:{primary:["#FF6B9D","#FF8FAB","#FFB3C6","#FFC2D1","#FF80AB"],secondary:["#FFCAD4","#F4ACB7","#E8909C","#F8AFA6"]},surprise:{primary:["#06D6A0","#1B9AAA","#00BBF9","#00F5D4","#3DDC97"],secondary:["#F15BB5","#FEE440","#9B5DE5","#00BBF9"]},calm:{primary:["#A8DADC","#B5EAEA","#CDFAD5","#E8F3F1","#C7F0DB"],secondary:["#F8F9FA","#E9ECEF","#DEE2E6","#F1F3F4"]}},pe=["nebula","marble","glow","sparkle","ripple"];function Zr(t){let e=2166136261;for(let r=0;r<t.length;r++)e^=t.charCodeAt(r),e=Math.imul(e,16777619);return Math.abs(e)}function Qr(t,e){const r=Zr(t+Date.now()),n=Kr[e.emotion],i=n.primary[r%n.primary.length],o=n.secondary[(r>>4)%n.secondary.length];let a;e.intensity>.85?a="sparkle":e.intensity>.65?a="nebula":e.intensity>.45?a="glow":e.intensity>.25?a="marble":a="ripple",r%17===0&&(a=pe[r%pe.length]);const l=Math.floor(60+e.intensity*30+r%10),s=r%1e3/1e3;let c;return s<.005?c="legendary":s<.05?c="epic":s<.2?c="rare":c="common",{color:i,color2:o,pattern:a,size:l,rarity:c}}const Bt={joy:"よろこび",sadness:"かなしみ",anger:"いかり",fear:"ふあん",love:"あい",surprise:"おどろき",calm:"やすらぎ"},it={joy:"✨",sadness:"💧",anger:"🔥",fear:"🌀",love:"💖",surprise:"⭐",calm:"🌿"};function Mt(t=""){const e=Date.now().toString(36),r=Math.random().toString(36).slice(2,10);return t?`${t}_${e}${r}`:`${e}${r}`}function tn(){const t="abcdefghijklmnopqrstuvwxyz0123456789";let e="";for(let r=0;r<8;r++)e+=t[Math.floor(Math.random()*t.length)];return e}async function Zt(t){const e=new TextEncoder().encode(t),r=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(r)).map(n=>n.toString(16).padStart(2,"0")).join("")}function de(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ue(t,e=2e3){return t.replace(/[\u0000-\u0008\u000B-\u001F\u007F]/g,"").slice(0,e).trim()}function fe(t,e=1,r=2e3){if(!t||typeof t!="string")return{ok:!1,error:"テキストが入力されていません"};const n=t.trim();return n.length<e?{ok:!1,error:`${e}文字以上入力してください`}:n.length>r?{ok:!1,error:`${r}文字以内で入力してください`}:{ok:!0}}function Qt(t){var e;return t.headers.get("cf-connecting-ip")||((e=t.headers.get("x-forwarded-for"))==null?void 0:e.split(",")[0])||"unknown"}async function ze(t,e,r,n){const i=Math.floor(Date.now()/1e3),o=i+n,a=await t.prepare("SELECT count, reset_at FROM rate_limits WHERE key = ?").bind(e).first();return!a||a.reset_at<i?(await t.prepare("INSERT INTO rate_limits (key, count, reset_at) VALUES (?, 1, ?) ON CONFLICT(key) DO UPDATE SET count=1, reset_at=?").bind(e,o,o).run(),{ok:!0,remaining:r-1,resetAt:o}):a.count>=r?{ok:!1,remaining:0,resetAt:a.reset_at}:(await t.prepare("UPDATE rate_limits SET count = count + 1 WHERE key = ?").bind(e).run(),{ok:!0,remaining:r-a.count-1,resetAt:a.reset_at})}function en(t,e="ja-JP"){return new Date(t).toLocaleDateString(e,{year:"numeric",month:"long",day:"numeric"})}function Pe(t){const e=t.size??200,r=Math.random().toString(36).slice(2,8),n=e/2,i=e/2,o=e*.42,a={common:"0",rare:"6",epic:"12",legendary:"20"}[t.rarity??"common"];let l="",s="";switch(t.pattern){case"nebula":l=`
        ...
        </radialGradient>`,s=`url(#g${r})`;break;default:s=t.color}const c=o*.35,d=n-o*.3,u=i-o*.35;let f="";if(t.pattern==="sparkle"||t.rarity==="legendary")for(let x=0;x<8;x++){const F=Math.PI*2*x/8,_=o*(.7+Math.random()*.4),$=n+Math.cos(F)*_,O=i+Math.sin(F)*_,J=2+Math.random()*3;f+=`<circle cx="${$}" cy="${O}" r="${J}" fill="white" opacity="${.6+Math.random()*.4}"/>`}const y=t.animated!==!1?`
    <animateTransform attributeName="transform" attributeType="XML" type="scale"
      ...
      <circle cx="${n}" cy="${i}" r="${o*1.15}" fill="none" stroke="gold" stroke-width="1.5" opacity="0.8">
        ${t.animated!==!1?`<animate attributeName="r" values="${o*1.15};${o*1.25};${o*1.15}" dur="2s" repeatCount="indefinite"/>`:""}
      </circle>`:t.rarity==="epic"&&(b=`<circle cx="${n}" cy="${i}" r="${o*1.1}" fill="none" stroke="${t.color2}" stroke-width="1" opacity="0.6"/>`),`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${e} ${e}" width="${e}" height="${e}">
    <defs>
      ${l}
    ...
    ${b}
    <g filter="url(#shadow${r})" transform-origin="${n} ${i}">
      ${y?`<g>${y}`:""}
      <circle cx="${n}" cy="${i}" r="${o}" fill="${s}"/>
      <ellipse cx="${d}" cy="${u}" rx="${c}" ry="${c*.6}" fill="white" opacity="0.55"/>
      <ellipse cx="${d+3}" cy="${u+3}" rx="${c*.5}" ry="${c*.3}" fill="white" opacity="0.35"/>
      ${f}
      ${y?"</g>":""}
    </g>
  </svg>`}function rn(t){const{title:e,emotion:r,color:n,color2:i,pattern:o,rarity:a,date:l}=t,c=Pe({color:n,color2:i,pattern:o,size:360,rarity:a,animated:!1}).replace(/^<svg[^>]*>/,"").replace(/<\/svg>$/,""),d=de(e.length>30?e.slice(0,28)+"…":e),u=it[r],f=Bt[r],y={common:"コモン",rare:"レア",epic:"エピック",legendary:"レジェンダリー"}[a]||"",b=de(l||"");return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
    <defs>
    ...
    <circle cx="1050" cy="500" r="220" fill="${i}" opacity="0.18" filter="url(#soft)"/>
    ...
    <g transform="translate(540, 180)">
      ...
      <g transform="translate(0, 130)">
        ...
        <rect x="220" y="0" rx="28" ry="28" width="220" height="56" fill="white" stroke="${i}" stroke-width="3"/>
        <text x="330" y="38" text-anchor="middle" font-family="'Hiragino Sans',sans-serif" font-size="24" fill="${i}" font-weight="700">${y}</text>
      </g>
...
`}function sn(t){const e=V(t.title),r=V(t.content||""),n=Bt[t.emotion],i=it[t.emotion],o=new Date(t.createdAt).toLocaleString("ja-JP",{year:"numeric",month:"long",day:"numeric"}),a=`/og/${t.shareId}.svg`,l=`${t.title} | ぷにメモリー`,s=t.opened?`${i} ${n} のオーブ（${he(t.rarity)}）。${o} の思い出。`:`🔒 タイムカプセル「${t.title}」が ${t.openAt?new Date(t.openAt).toLocaleDateString("ja-JP"):""} に開封されます。`,c=ln(t);return`<!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"/>
...
<main class="puni-share-main">
  <div class="puni-share-card">
    ...
    <p class="puni-share-date">${o}</p>
    <div class="puni-share-badges">
      <span class="puni-badge puni-badge-emotion">${i} ${n}</span>
...
</html>`}function V(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function he(t){return{common:"コモン",rare:"レア",epic:"エピック",legendary:"レジェンダリー"}[t]||t}function ln(t){const o="sh"+Math.random().toString(36).slice(2,6);let a="";switch(t.pattern){case"sparkle":a=`<radialGradient id="g${o}" cx="40%" cy="35%"><stop offset="0%" stop-color="white" stop-opacity="0.95"/><stop offset="20%" stop-color="${t.color2}"/><stop offset="100%" stop-color="${t.color}"/></radialGradient>`;break;case"nebula":a=`<radialGradient id="g${o}" cx="35%" cy="30%"><stop offset="0%" stop-color="${t.color2}"/><stop offset="60%" stop-color="${t.color}"/><stop offset="100%" stop-color="${t.color}" stop-opacity="0.7"/></radialGradient>`;break;case"marble":a=`<linearGradient id="g${o}"><stop offset="0%" stop-color="${t.color}"/><stop offset="50%" stop-color="${t.color2}"/><stop offset="100%" stop-color="${t.color}"/></linearGradient>`;break;case"glow":a=`<radialGradient id="g${o}"><stop offset="0%" stop-color="${t.color2}" stop-opacity="0.9"/><stop offset="60%" stop-color="${t.color}"/><stop offset="100%" stop-color="${t.color}" stop-opacity="0.6"/></radialGradient>`;break;default:a=`<radialGradient id="g${o}"><stop offset="0%" stop-color="${t.color}"/><stop offset="40%" stop-color="${t.color2}" stop-opacity="0.7"/><stop offset="80%" stop-color="${t.color}"/></radialGradient>`}let l="";if(t.pattern==="sparkle"||t.rarity==="legendary")for(let c=0;c<8;c++){const d=Math.PI*2*c/8,u=100.8*(.75+c%3*.1);l+=`<circle cx="${120+Math.cos(d)*u}" cy="${120+Math.sin(d)*u}" r="${2+c%2}" fill="white" opacity="0.85"/>`}let s="";return t.rarity==="legendary"?s=`<circle cx="120" cy="120" r="${100.8*1.15}" fill="none" stroke="gold" stroke-width="2" opacity="0.8"><animate attributeName="r" values="${100.8*1.15};${100.8*1.25};${100.8*1.15}" dur="2s" repeatCount="indefinite"/></circle>`:t.rarity==="epic"&&(s=`<circle cx="120" cy="120" r="${100.8*1.1}" fill="none" stroke="${t.color2}" stroke-width="1.5" opacity="0.6"/>`),t.opened?`<svg viewBox="0 0 240 240" width="240" height="240" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ${a}
      <filter id="sh${o}" x="-50%" y="-50%" width="200%" height="200%"><feGaussianBlur in="SourceAlpha" stdDeviation="8"/><feOffset dx="0" dy="3"/><feFlood flood-color="${t.color2}" flood-opacity="0.6"/><feComposite in2="SourceAlpha" operator="in"/><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge></filter>
    </defs>
    ${s}
    <g filter="url(#sh${o})">
      <g transform-origin="120 120">
        ...
        <circle cx="120" cy="120" r="${100.8}" fill="url(#g${o})"/>
      ...
      <defs><radialGradient id="lk${o}"><stop offset="0%" stop-color="#E8DEF5"/><stop offset="100%" stop-color="#C5B5E0"/></radialGradient></defs>
      <circle cx="120" cy="120" r="${100.8}" fill="url(#lk${o})" opacity="0.85"/>
...
`}const w=new je;w.use("*",Dr({contentSecurityPolicy:{defaultSrc:["'self'"],scriptSrc:["'self'","'unsafe-inline'"],styleSrc:["'self'","'unsafe-inline'","https://fonts.googleapis.com"],fontSrc:["'self'","https://fonts.gstatic.com","data:"],imgSrc:["'self'","data:","https:"],connectSrc:["'self'"],frameAncestors:["'none'"],baseUri:["'self'"],formAction:["'self'"]},xFrameOptions:"DENY",xContentTypeOptions:"nosniff",referrerPolicy:"strict-origin-when-cross-origin",permissionsPolicy:{camera:[],microphone:[],geolocation:[],interestCohort:[]}}));w.use("/api/*",_r({origin:t=>t||"*",credentials:!0,maxAge:600}));w.use("*",Mr());async function xt(t){let e=Kt(t,"puni_uid");if(e)await t.env.DB.prepare("UPDATE users SET last_active_at = ? WHERE id = ?").bind(Date.now(),e).run();else{e=Mt("u"),Wr(t,"puni_uid",e,{httpOnly:!0,secure:!0,sameSite:"Lax",maxAge:3600*24*390,path:"/"});const r=Date.now();await t.env.DB.prepare("INSERT OR IGNORE INTO users (id, created_at, last_active_at) VALUES (?, ?, ?)").bind(e,r,r).run()}return e}async function yt(t,e,r){try{const n=Qt(t.req.raw),i=t.req.header("user-agent")||"",o=t.req.header("referer")||"",a=await Zt(n+"puni-salt-2025"),l=Kt(t,"puni_uid")||null;await t.env.DB.prepare("INSERT INTO analytics_events (id, user_id, event_type, payload, ip_hash, user_agent, referrer, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)").bind(Mt("e"),l,e,r?JSON.stringify(r).slice(0,1e3):null,a.slice(0,16),i.slice(0,200),o.slice(0,200),Date.now()).run()}catch(n){console.error("analytics error",n)}}w.get("/api/health",t=>t.json({ok:!0,ts:Date.now()}));w.post("/api/capsules",async t=>{try{const e=await xt(t),r=Qt(t.req.raw),n=await Zt(r+"rl-salt"),i=await ze(t.env.DB,`cap:${n.slice(0,16)}`,20,3600);if(!i.ok)return t.json({error:"たくさん作りすぎだよ！少し休もう🍵",resetAt:i.resetAt},429);const o=await t.req.json(),a=ue(o.title||"",60),l=ue(o.content||"",2e3),s=fe(a,1,60);if(!s.ok)return t.json({error:s.error},400);const c=fe(l,5,2e3);if(!c.ok)return t.json({error:c.error},400);const d=Xr(l),u=Qr(l,d),f=Mt("c"),y=tn(),b=Date.now(),x=o.openAt&&o.openAt>b?Math.min(o.openAt,b+1e3*60*60*24*365*5):null,F=o.isPublic?1:0;return await t.env.DB.prepare(`INSERT INTO capsules (id, user_id, title, content, emotion, emotion_score, orb_color, orb_color_2, orb_pattern, orb_size, rarity, share_id, is_public, open_at, opened, created_at)
       VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`).bind(f,e,a,l,d.emotion,d.score,u.color,u.color2,u.pattern,u.size,u.rarity,y,F,x,x?0:1,b).run(),await t.env.DB.prepare("UPDATE users SET total_capsules = total_capsules + 1, total_orbs = total_orbs + 1 WHERE id = ?").bind(e).run(),await yt(t,"capsule_created",{emotion:d.emotion,rarity:u.rarity,hasOpenAt:!!x,isPublic:!!F,length:l.length}),t.json({id:f,shareId:y,title:a,content:l,emotion:d.emotion,emotionLabel:Bt[d.emotion],emotionEmoji:it[d.emotion],score:d.score,intensity:d.intensity,orb:u,openAt:x,opened:!x,isPublic:!!F,createdAt:b,shareUrl:`/c/${y}`})}catch(e){return console.error("create capsule error",e),t.json({error:"カプセル生成に失敗したよ。もう一度試してね。"},500)}});w.get("/api/capsules",async t=>{const e=await xt(t),r=Math.min(parseInt(t.req.query("limit")||"50"),100),n=Math.max(parseInt(t.req.query("offset")||"0"),0),{results:i}=await t.env.DB.prepare(`SELECT id, title, content, emotion, emotion_score, orb_color, orb_color_2, orb_pattern, orb_size, rarity, share_id, is_public, open_at, opened, created_at
     FROM capsules WHERE user_id = ?
     ORDER BY created_at DESC LIMIT ? OFFSET ?`).bind(e,r,n).all(),o=Date.now(),a=[],l=(i||[]).map(s=>{let c=!!s.opened;return!c&&s.open_at&&s.open_at<=o&&(c=!0,a.push(s.id)),{id:s.id,title:s.title,content:c?s.content:null,emotion:s.emotion,emotionLabel:Bt[s.emotion],emotionEmoji:it[s.emotion],score:s.emotion_score,orb:{color:s.orb_color,color2:s.orb_color_2,pattern:s.orb_pattern,size:s.orb_size,rarity:s.rarity},shareId:s.share_id,isPublic:!!s.is_public,openAt:s.open_at,opened:c,createdAt:s.created_at}});if(a.length){const s=a.map(()=>"?").join(",");await t.env.DB.prepare(`UPDATE capsules SET opened = 1 WHERE id IN (${s})`).bind(...a).run()}return t.json({items:l,count:l.length})});w.get("/api/stats",async t=>{const e=await xt(t),r=await t.env.DB.prepare("SELECT COUNT(*) as n FROM capsules WHERE user_id = ?").bind(e).first(),n=await t.env.DB.prepare("SELECT emotion, COUNT(*) as n FROM capsules WHERE user_id = ? GROUP BY emotion").bind(e).all(),i=await t.env.DB.prepare("SELECT rarity, COUNT(*) as n FROM capsules WHERE user_id = ? GROUP BY rarity").bind(e).all(),o=await t.env.DB.prepare("SELECT created_at FROM capsules WHERE user_id = ? AND created_at > ? ORDER BY created_at DESC").bind(e,Date.now()-1e3*60*60*24*30).all(),a=new Set;for(const c of o.results||[])a.add(new Date(c.created_at).toISOString().slice(0,10));let l=0;const s=new Date;for(let c=0;c<90;c++){const d=new Date(s);d.setDate(d.getDate()-c);const u=d.toISOString().slice(0,10);if(a.has(u))l++;else if(c>0)break}return t.json({total:(r==null?void 0:r.n)||0,byEmotion:Object.fromEntries((n.results||[]).map(c=>[c.emotion,c.n])),byRarity:Object.fromEntries((i.results||[]).map(c=>[c.rarity,c.n])),streak:l})});w.delete("/api/capsules/:id",async t=>{const e=await xt(t),r=t.req.param("id");return(await t.env.DB.prepare("DELETE FROM capsules WHERE id = ? AND user_id = ?").bind(r,e).run()).meta.changes===0?t.json({error:"not found"},404):(await yt(t,"capsule_deleted",{id:r}),t.json({ok:!0}))});w.patch("/api/capsules/:id/public",async t=>{const e=await xt(t),r=t.req.param("id"),{isPublic:n}=await t.req.json();return await t.env.DB.prepare("UPDATE capsules SET is_public = ? WHERE id = ? AND user_id = ?").bind(n?1:0,r,e).run(),t.json({ok:!0})});w.get("/api/gallery",async t=>{const e=t.req.query("tab")||"recent",r=Math.min(parseInt(t.req.query("limit")||"24"),50);let n="";e==="popular"?n=`
      ...
      ORDER BY created_at DESC LIMIT ?`;const{results:i}=await t.env.DB.prepare(n).bind(Date.now(),r).all();return t.json({items:(i||[]).map(o=>({shareId:o.share_id,title:o.title,emotion:o.emotion,emotionEmoji:it[o.emotion],orb:{color:o.orb_color,color2:o.orb_color_2,pattern:o.orb_pattern,size:o.orb_size,rarity:o.rarity},reactions:o.reactions||0,createdAt:o.created_at}))})});w.get("/api/daily-prompt",t=>{const e=["今日いちばんテンション上がった瞬間は？","最近のちっちゃい幸せを教えて 🌱","今、心がモヤモヤしてること、書き出してみよう","5年後の自分にメッセージを送るなら？",'今日出会った"いいもの"を記録しよう ✨',"明日への一言を未来の自分へ","今ハマっていることは？",'最近"ありがとう"を言いたい人は？',"心が落ち着くもの・場所は？","今日の自分を褒めてあげよう 💖","一番怖いものは？それでも頑張ってる？","最近笑ったこと、思い出してみよう 😂","今好きな人・物・推しを語って 🌟","今日の体調・気分を一言で","今この瞬間に感謝したいこと"],r=new Date,i=(r.getFullYear()*1e4+(r.getMonth()+1)*100+r.getDate())%e.length;return t.json({prompt:e[i],date:r.toISOString().slice(0,10)})});w.get("/api/share/:shareId",async t=>{const e=t.req.param("shareId"),r=await t.env.DB.prepare(`SELECT id, title, content, emotion, emotion_score, orb_color, orb_color_2, orb_pattern, orb_size, rarity, is_public, open_at, opened, created_at
     FROM capsules WHERE share_id = ?`).bind(e).first();if(!r)return t.json({error:"not found"},404);const n=Date.now(),i=!!r.opened||r.open_at&&r.open_at<=n;return t.json({title:r.title,content:i?r.content:null,emotion:r.emotion,emotionLabel:Bt[r.emotion],emotionEmoji:it[r.emotion],score:r.emotion_score,orb:{color:r.orb_color,color2:r.orb_color_2,pattern:r.orb_pattern,size:r.orb_size,rarity:r.rarity},isPublic:!!r.is_public,openAt:r.open_at,opened:i,createdAt:r.created_at})});w.post("/api/share/:shareId/react",async t=>{const e=t.req.param("shareId"),{reaction:r}=await t.req.json();if(!["love","sparkle","calm","wow"].includes(r))return t.json({error:"invalid"},400);const i=Qt(t.req.raw),o=await Zt(i+"react");if(!(await ze(t.env.DB,`react:${o.slice(0,16)}:${e}`,10,3600)).ok)return t.json({error:"もう少し待ってね"},429);const l=await t.env.DB.prepare("SELECT id FROM capsules WHERE share_id = ?").bind(e).first();return l?(await t.env.DB.prepare("INSERT INTO reactions (id, capsule_id, user_id, reaction, created_at) VALUES (?, ?, ?, ?, ?)").bind(Mt("r"),l.id,Kt(t,"puni_uid")||null,r,Date.now()).run(),await yt(t,"reaction_added",{reaction:r,shareId:e}),t.json({ok:!0})):t.json({error:"not found"},404)});w.get("/api/share/:shareId/reactions",async t=>{const e=t.req.param("shareId"),r=await t.env.DB.prepare("SELECT id FROM capsules WHERE share_id = ?").bind(e).first();if(!r)return t.json({error:"not found"},404);const{results:n}=await t.env.DB.prepare("SELECT reaction, COUNT(*) as n FROM reactions WHERE capsule_id = ? GROUP BY reaction").bind(r.id).all();return t.json({reactions:Object.fromEntries((n||[]).map(i=>[i.reaction,i.n]))})});w.post("/api/analytics",async t=>{try{const e=await t.req.json();return!e.event||typeof e.event!="string"||e.event.length>50?t.json({ok:!1},400):(await yt(t,e.event,e.payload),t.json({ok:!0}))}catch{return t.json({ok:!1},400)}});w.get("/orb/:filename{.+\\.svg}",async t=>{const e=t.req.param("filename").replace(/\.svg$/,""),r=await t.env.DB.prepare("SELECT orb_color, orb_color_2, orb_pattern, orb_size, rarity, emotion FROM capsules WHERE share_id = ?").bind(e).first();if(!r)return t.text("not found",404);const n=Pe({color:r.orb_color,color2:r.orb_color_2,pattern:r.orb_pattern,size:400,rarity:r.rarity,emotion:r.emotion});return new Response(n,{headers:{"Content-Type":"image/svg+xml; charset=utf-8","Cache-Control":"public, max-age=3600"}})});w.get("/og/:filename{.+\\.svg}",async t=>{const e=t.req.param("filename").replace(/\.svg$/,""),r=await t.env.DB.prepare("SELECT title, emotion, orb_color, orb_color_2, orb_pattern, rarity, created_at FROM capsules WHERE share_id = ?").bind(e).first();if(!r)return t.text("not found",404);const n=rn({title:r.title,emotion:r.emotion,color:r.orb_color,color2:r.orb_color_2,pattern:r.orb_pattern,rarity:r.rarity,date:en(r.created_at)});return new Response(n,{headers:{"Content-Type":"image/svg+xml; charset=utf-8","Cache-Control":"public, max-age=3600"}})});w.get("/",async t=>(await xt(t),await yt(t,"page_view",{page:"home"}),t.html(Nt())));w.get("/c/:shareId",async t=>{const e=t.req.param("shareId"),r=await t.env.DB.prepare(`SELECT title, content, emotion, orb_color, orb_color_2, orb_pattern, orb_size, rarity, is_public, open_at, opened, created_at
     FROM capsules WHERE share_id = ?`).bind(e).first();return r?(await yt(t,"share_view",{shareId:e}),t.html(sn({shareId:e,title:r.title,content:r.content,emotion:r.emotion,color:r.orb_color,color2:r.orb_color_2,pattern:r.orb_pattern,rarity:r.rarity,openAt:r.open_at,opened:!!r.opened||r.open_at&&r.open_at<=Date.now(),isPublic:!!r.is_public,createdAt:r.created_at}))):t.html(Nt({error:"カプセルが見つかりませんでした"}),404)});w.get("/manifest.json",t=>t.json({name:"ぷにメモリー",short_name:"ぷにメモリー",description:'あなたの"今"をAIが永久保存するぷにぷに思い出カプセル',start_url:"/",display:"standalone",background_color:"#FDF6FF",theme_color:"#FFD6E8",orientation:"portrait",icons:[{src:"/icon-192.svg",sizes:"192x192",type:"image/svg+xml",purpose:"any maskable"},{src:"/icon-512.svg",sizes:"512x512",type:"image/svg+xml",purpose:"any maskable"}],categories:["lifestyle","productivity","social"]}));const He=t=>{const r=new URL(t.req.url).pathname.match(/icon-(\d+)\.svg/),n=r?parseInt(r[1]):192,i=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${n} ${n}">
    <defs>
  ...
  </svg>`;return new Response(i,{headers:{"Content-Type":"image/svg+xml; charset=utf-8","Cache-Control":"public, max-age=86400"}})};w.get("/icon-192.svg",He);w.get("/icon-512.svg",He);w.get("/og.svg",t=>{const e=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630" width="1200" height="630">
    <defs>
      <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
  ...
  </svg>`;return new Response(e,{headers:{"Content-Type":"image/svg+xml; charset=utf-8","Cache-Control":"public, max-age=3600"}})});w.get("/manifest.json",t=>t.json({name:"ぷにメモリー",short_name:"ぷにメモリー",description:"AIがあなたの気持ちをぷにぷにオーブに変える",start_url:"/",display:"standalone",theme_color:"#FFD6E8",background_color:"#FDF6FF",lang:"ja",icons:[{src:"/favicon.ico",sizes:"any",type:"image/svg+xml"}]}));w.get("/api/feed",async t=>{const e=Math.min(parseInt(t.req.query("limit")||"12"),50),{results:r}=await t.env.DB.prepare(`SELECT share_id, title, emotion, orb_color, orb_color_2, orb_pattern, orb_size, rarity, created_at
     FROM capsules WHERE is_public = 1 AND opened = 1
     ORDER BY created_at DESC LIMIT ?`).bind(e).all(),n=(r||[]).map(i=>({shareId:i.share_id,title:i.title,emotion:i.emotion,emotionEmoji:it[i.emotion],orb:{color:i.orb_color,color2:i.orb_color_2,pattern:i.orb_pattern,size:i.orb_size,rarity:i.rarity},createdAt:i.created_at}));return t.json({items:n})});w.get("/favicon.ico",t=>{const e="<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><defs><radialGradient id='g' cx='35%' cy='30%'><stop offset='0%' stop-color='%23FFD6E8'/><stop offset='100%' stop-color='%23FF8FB1'/></radialGradient></defs><circle cx='32' cy='32' r='26' fill='url(%23g)'/><ellipse cx='24' cy='22' rx='8' ry='5' fill='white' opacity='0.6'/></svg>";return new Response(e,{headers:{"Content-Type":"image/svg+xml","Cache-Control":"public, max-age=86400"}})});w.get("/robots.txt",t=>t.text(`User-agent: *
Allow: /
Disallow: /api/
Sitemap: ${new URL(t.req.url).origin}/sitemap.xml
`));w.get("/sitemap.xml",t=>{const e=new URL(t.req.url).origin;return t.text(`<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
<url><loc>${e}/</loc><changefreq>daily</changefreq><priority>1.0</priority></url>
</urlset>`,200,{"Content-Type":"application/xml"})});w.notFound(t=>t.html(Nt({error:"ページが見つかりませんでした"}),404));w.onError((t,e)=>(console.error("app error",t),e.html(Nt({error:"エラーが発生しました"}),500)));const ge=new je,pn=Object.assign({"/src/index.tsx":w});let Me=!1;for(const[,t]of Object.entries(pn))t&&(ge.all("*",e=>{let r;try{r=e.executionCtx}catch{}return t.fetch(e.req.raw,e.env,r)}),ge.notFound(e=>{let r;try{r=e.executionCtx}catch{}return t.fetch(e.req.raw,e.env,r)}),Me=!0);if(!Me)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{ge as default};
